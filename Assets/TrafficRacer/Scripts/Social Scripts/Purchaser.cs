...
public class Purchaser : MonoBehaviour//, IStoreListener
{
    ...
    public static string PRODUCT_NOADS = "com.madfireon.noads"; //this is the id which you need to add in you google store or app store purchase
    ...
    public void RestorePurchases()
    {
            ...
            Application.platform == RuntimePlatform.OSXPlayer)
        {
            ...
            apple.RestoreTransactions((result) =>
            {
                ...
                GuiManager.instance.NoAdsBtn.interactable = false;
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        if (String.Equals(args.purchasedProduct.definition.id, PRODUCT_NOADS, StringComparison.Ordinal))
        {
            ...
            GameManager.instance.GDPRConset = 1;
            GuiManager.instance.GDPRpanel.SetActive(false);
            GameManager.instance.canShowAds = false;
            GameManager.instance.Save();
            GuiManager.instance.NoAdsBtn.interactable = false;
        } 
